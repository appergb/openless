...
export const en: typeof zhCN = {
  macDictationKey: {
    ...
    retry: "Retry Mac Dictation key",
    active: "Mac Dictation key is the current trigger.",
    inactive: "This shortcut is not active. Retry from the menu or choose another key.",
