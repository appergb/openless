...
export const zhTW: typeof zhCN = {
  ...
  overview: {
    ...
    guide: {
      ...
      servicesDesc: "建議從這裡開始：選擇語音辨識和文字處理服務；使用 Omni 時，只需設定目前的多模態模型。",
  ...
  settings: {
    ...
    channels: {
      ...
      validationHint: "手動發出一次實際請求，檢查目前設定；可能消耗服務額度。儲存設定不會自動驗證。",
  ...
  startup: {
    ...
    recovery: "請重新檢查。如果仍然失敗，請完全結束後重開應用程式；升級後出現此問題時，確認已安裝完整的同一版本。",
    retry: "重新檢查",
    details: "查看錯誤詳情",
  },
  modal: {
  ...
  localAsr: {
    ...
    downloadDialogAlreadyHave: "模型檔案已下載。可返回模型頁載入並測試，或在「ASR 語音轉寫」中選擇對應供應商。",
    downloadDialogDesc: "查看模型大小與簡介，選擇後開始下載。下載完成後，在「語音辨識」中選擇對應的本機服務。",
    detailRepo: '模型倉庫',
    hfDownloads: '下載量',
    hfLikes: '收藏數',
    hfDescription: '模型簡介',
    ...
    libraryEmptyDesc: "下載一個語音辨識模型，讓音訊在本機處理。已有模型卻未顯示時，可重新讀取目錄。",
    catalogTitle: "模型目錄",
